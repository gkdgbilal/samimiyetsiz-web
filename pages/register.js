            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="mt-8 space-y-6">
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div>
                            <input aria-label="username" name="username" type="text" ref={usernameRef}
                            ...
                            />
                            {/*} <FormInput name="username" type="text" className="rounded-t-md" placeholder="username" /> */}
                        </div>
                        <div className="-mt-px">
                            <input aria-label="email" name="email" type="email" ref={emailRef} placeholder="email"
                                   required
                                   className={`  appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 
                        ...
                        <div className="-mt-px">
                            <input aria-label="password" name="password" type="password" ref={passwordRef}
